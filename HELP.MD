...
To serve files using GitHub as a CDN, use https://cdn.jsdelivr.net/gh/[github name]/[file details]. 
...
* Enable it be seen in the toolbar
    * Click on the jigsaw piece in top right hand corner of the browser anc click on a pin to make it visible.
