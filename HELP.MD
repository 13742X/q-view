...
View-Q has some extra syntax, not included in the main protocol. These are to add extra functionality such as embedding responsive YouTube videos or grouping text.
